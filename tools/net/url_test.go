...
func TestRawURLGetParam(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "single param",
			args: args{
				raw: "http://www.veyron.com:8080/indexhtml?boardID=520&page=1&page=2#name",
				key: "boardID",
			},
			want:    "520",
			wantErr: false,
...
func TestRawURLGetParams(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "url invalid",
			args: args{
				raw: "http://www.veyron.com:8080/indexhtml?boardID\r=520&page=1&page=2#name",
				key: "foo",
			},
			want:    nil,
			wantErr: true,
...
func TestRawURLGetAllParams(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "single param",
			args: args{
				raw: "http://www.veyron.com:8080/indexhtml?boardID=520#name",
			},
		...
		},
		{
			name: "no param",
			args: args{
				raw: "http://www.veyron.com:8080/indexhtml#name",
			},
			want:    map[string][]string{},
			wantErr: false,
		},
		{
			name: "url invalid",
			args: args{
				raw: "http://www.veyron.com:8080/indexhtml\r#name",
			},
			want:    nil,
			wantErr: true,
		},
...
func TestRawURLAddParam(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want:    "http://www.veyron.com:8080/indexhtml?boardID=520&page=1#name",
			wantErr: false,
		},
		{
			name: "multiple params",
			args: args{
				raw:   "http://www.veyron.com:8080/indexhtml?boardID=520&page=1#name",
				key:   "page",
				value: "2",
			},
			want:    "http://www.veyron.com:8080/indexhtml?boardID=520&page=1&page=2#name",
			wantErr: false,
		},
		{
			name: "only host url",
...
func TestRawURLDelParams(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want:    "http://www.veyron.com:8080/indexhtml#name",
			wantErr: false,
		},
		{
			name: "only host url",
...
func TestRawURLSetParam(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want:    "http://www.veyron.com:8080/indexhtml?boardID=520&page=3#name",
			wantErr: false,
		},
		{
			name: "only host url",
...
func TestRawURLSetParams(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want:    "http://www.veyron.com:8080/indexhtml?boardID=1024&page=3#name",
			wantErr: false,
		},
		{
			name: "only host url",
...
func TestRawURLGetDomain(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "no host url",
			args: args{
				raw: "http://:8080/indexhtml?boardID=520&page=1&page=2#name",
			},
			want:    "",
			wantErr: false,
		},
		{
			name: "url invalid",
			args: args{
				raw: "http://foo\r:8080/indexhtml?boardID=520&page=1&page=2#name",
			},
			want:    "",
			wantErr: true,
		},
...
func TestRawURLGetPort(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "no port url",
			args: args{
				raw: "http://www.veyron.com/indexhtml?boardID=520&page=1&page=2#name",
			},
			want:    "",
			wantErr: false,
		},
